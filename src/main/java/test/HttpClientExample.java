...
//    }
//    
////    public static void httpRequest(String uri, Map<String, ?> uriVariables, Map<String, ?> queryParams, Object postData) throws URISyntaxException, IOException, InterruptedException {
////    	 HttpClient client = HttpClient.newHttpClient();
////    	 HttpRequest.Builder builder = HttpRequest.newBuilder().version(HttpClient.Version.HTTP_2);
////    	 builder=uri!=null?builder.uri(URI.create(uri)):builder;
////    	 builder=uri!=null?builder.uri(URI.create(uri)):builder;
////    	 
////    }
////    
...
//        SdkHttpClient client = new SdkHttpClient();
//        SdkHttpFullRequest request = SdkHttpFullRequest.builder()
//            .uri(URI.create("http://jsonplaceholder.typicode.com/posts/1"))
//            .build();
//        SdkHttpResponse<String> response = client.send(request, BodyHandlers.ofString());
//        SdkHttpFullRequest requestSdk= request;
